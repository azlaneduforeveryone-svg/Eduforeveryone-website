...
const CURRENCIES: Record<string, { main: string; mainPl: string; sub: string; subPl: string }> = {
  USD: { main: "dollar", mainPl: "dollars", sub: "cent", subPl: "cents" },
  SAR: { main: "riyal", mainPl: "riyals", sub: "halala", subPl: "halalas" },
  INR: { main: "rupee", mainPl: "rupees", sub: "paisa", subPl: "paise" },
  PKR: { main: "rupee", mainPl: "rupees", sub: "paisa", subPl: "paise" },
  EUR: { main: "euro", mainPl: "euros", sub: "cent", subPl: "cents" },
  GBP: { main: "pound", mainPl: "pounds", sub: "penny", subPl: "pence" },
  AED: { main: "dirham", mainPl: "dirhams", sub: "fils", subPl: "fils" },
  EGP: { main: "pound", mainPl: "pounds", sub: "piaster", subPl: "piasters" },
};
...
function toWordsAR(n: number): string {
  ...
  if (n < 100) return tens_ar[Math.floor(n / 10)] + (n % 10 ? " و" + ones_ar[n % 10] : "");
...
function getWords(langId: string, n: number, currency: string): string {
  ...
  if (currency && CURRENCIES[currency]) {
    ...
    const unit = n === 1 ? c.main : c.mainPl;
    base = base + " " + unit + " only";
  }
  return base;
}
